...
public class Fork<E extends Comparable<E>> implements Bst<E> {
	...
	private ArrayList<E> sortedArray = new ArrayList<E>();
	final E[] elements;
	...
	public Fork(E root, Bst<E> left, Bst<E> right) {
		...
		this.elements = (E[]) Array.newInstance(root.getClass(), size());
	...
	public Bst<E> insert(E e) { // Returns a copy of this with e inserted. elements)
	...
	public Bst<E> balance() {
		return balanced(0, size(), elements);
